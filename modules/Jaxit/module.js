...
class Jaxit {
  ...
  defaultStyle() {
    this.jaxconsole.className = "grid-item jaxit-console";
    this.jaxconsole.style.backgroundColor = 'black';
    this.jaxconsole.style.position = 'relative';
    this.jaxconsole.style.bottom = '10%';
    this.jaxconsole.style.right = '-4%';
    this.jaxconsole.style.width = "88%";
    this.jaxconsole.style.height = "10%";
    this.jaxconsole.style.fontFamily = 'monospace';
    this.jaxconsole.style.padding = '1%';
    this.jaxconsole.style.margin = '1%';        
  }
}
